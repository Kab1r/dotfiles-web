...
impl Component for CodeButton {
    ...
    fn view(&self) -> Html {
        ...
        html! {
            <button onclick=code_click_callback class="flex mx-auto mt-2 text-white bg-gray-700 active:bg-indigo-600 border-0 py-2 px-4 focus:outline-none rounded text-lg ">
